...
import com.ksoot.spark.springframework.boot.autoconfigure.error.JobErrorType;
import com.ksoot.spark.springframework.boot.autoconfigure.error.JobProblem;
import com.ksoot.spark.springframework.boot.autoconfigure.util.DurationRepresentation;
