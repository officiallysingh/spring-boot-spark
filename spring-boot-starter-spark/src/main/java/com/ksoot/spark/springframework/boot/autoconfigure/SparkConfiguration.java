...
public class SparkConfiguration {
  ...
  private static final String SPARK_SESSION_BEAN_NAME = "sparkSession";
  private static final String SPARK_PROPERTIES_BEAN_NAME = "sparkProperties";
  private static final String SPARK_CONF_BEAN_NAME = "sparkConf";
