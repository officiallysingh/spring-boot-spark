...
import com.ksoot.spark.springframework.boot.autoconfigure.util.StringUtils;
...
import static com.ksoot.spark.springframework.boot.autoconfigure.error.JobErrorType.BAD_REQUEST_TITLE;
