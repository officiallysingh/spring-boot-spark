...
public class SpringTest {
  ...
  @Autowired private ArangoHealthIndicator arangoHealthIndicator;

  @Autowired private CatRepo repo;

  @Autowired private MouseRepo referencingRepo;
  ...
  void event() {
    ...
    assertThat(listener.events)
        .describedAs("event after resolving cat")
  ...
  private static boolean matches(
      ArangoMappingEvent<?> event, Class<? extends ArangoMappingEvent> type, Object source) {
