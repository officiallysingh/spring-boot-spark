...
import static com.ksoot.spark.common.error.SparkError.BAD_REQUEST_TITLE;
...
@Getter
public class SparkProblem extends NestedRuntimeException {
  ...
  private SparkProblem(final ErrorType errorType, final Throwable cause, final Object[] args) {
  ...
  private static String reason(
      ...
      final Object[] args) {
    return com.ksoot.spark.common.util.StringUtils.substitute(
        REASON_TEMPLATE,
        "code",
        code,
        "title",
  ...
  public static CauseBuilder of(final String message) {
    return new SparkProblemBuilder(SparkError.of(message));
  }

  public static CauseBuilder of(final String title, final String message) {
    return new SparkProblemBuilder(SparkError.of(title, message));
  }
  ...
  public static SparkProblem badRequest(final String message) {
    return new SparkProblem(SparkError.of(BAD_REQUEST_TITLE, message), null, null);
  }
  ...
  public interface ArgsBuilder extends Builder<SparkProblem> {
    Builder<SparkProblem> args(@Nullable final Object... args);
  }
  ...
  static class SparkProblemBuilder implements CauseBuilder {
    ...
    @Override
    public Builder<SparkProblem> args(@Nullable final Object[] args) {
      this.args = args;
      return this;
    }

    @Override
    public SparkProblem build() {
      return new SparkProblem(this.errorType, this.cause, this.args);
    }
  }
}
