# Spark Word Count Job implemented as Sporing Cloud Task

Run [**`SparkStatementJob`**](src/main/java/com/ksoot/spark/statement/SparkStatementJob.java) as Spring boot application.
...
./bin/spark-submit \
    ...
    --class com.ksoot.spark.statement.SparkStatementJob \
